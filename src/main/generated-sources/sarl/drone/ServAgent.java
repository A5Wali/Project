...
public class ServAgent extends Agent {
  ...
  private void $behaviorUnit$Initialize$0(final Initialize occurrence) {
    try {
      ...
      _$CAPACITY_USE$IO_SARL_CORE_LIFECYCLE$CALLER.spawn(DroneAgent.class);
      ...
      _$CAPACITY_USE$IO_SARL_CORE_LIFECYCLE$CALLER_1.spawn(BufferReaderAgent.class, this.socket);
  ...
  public boolean equals(final Object obj) {
    ...
    if (getClass() != obj.getClass())
      return false;
    ServAgent other = (ServAgent) obj;
    if (this.socketServer == null) {
      if (other.socketServer != null)
        return false;
    } else if (!this.socketServer.equals(other.socketServer))
      return false;
    if (this.socket == null) {
  ...
  public int hashCode() {
    ...
    result = prime * result + ((this.socketServer== null) ? 0 : this.socketServer.hashCode());
